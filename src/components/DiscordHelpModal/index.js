				...
				<form>
					...
					<div className='body'>
						<ul>
							...
							<li>
								Add WidgetBot to your Discord server using{' '}
								<a href='https://add.widgetbot.io/' target='_blank' rel='noopener noreferer'>
									this link
								</a>
								.
							</li>
					...
					<div className='footerDis'>
						...
						<div className='footer'>
							...
							<button onClick={submitDiscord} className='submitBtn'>
								Submit
							</button>
						</div>
					</div>
