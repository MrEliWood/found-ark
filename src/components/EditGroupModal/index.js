...
function EditGroupModal({ setOpenModal, setGroup, group }) {
	...
	// time zone array
	const timeZones = ['(GMT+00:00) Greenwich Mean Time', '(GMT+01:00) European Central Time', '(GMT+02:00) Eastern European Time', '(GMT+03:00) Eastern African Time', '(GMT+03:30) Middle East Time', '(GMT+04:00) Near East Time', '(GMT+05:00) Pakistan Lahore Time', '(GMT+05:30) India Standard Time', '(GMT+06:00) Bangladesh Standard Time', '(GMT+07:00) Vietnam Standard Time', '(GMT+08:00) China Taiwan Time', '(GMT+09:00) Japan Standard Time', '(GMT+09:30) Australia Central Time', '(GMT+10:00) Australia Eastern Time', '(GMT+11:00) Solomon Standard Time', '(GMT+12:00) New Zealand Standard Time', '(GMT-11:00) Midway Islands Time', '(GMT-10:00) Hawaii Standard Time', '(GMT-09:00) Alaska Standard Time', '(GMT-08:00) Pacific Standard Time', '(GMT-07:00) Phoenix Standard Time', '(GMT-07:00) Mountain Standard Time', '(GMT-06:00) Central Standard Time', '(GMT-05:00) Eastern Standard Time', '(GMT-05:00) Indiana Eastern Standard Time', '(GMT-04:00) Puerto Rico and US Virgin Islands Time', '(GMT-03:30) Canada Newfoundland Time', '(GMT-03:00) Argentina Standard Time', '(GMT-03:00) Brazil Eastern Time', '(GMT-01:00) Central African Time'];
		...
		<div className='modalBackground' onClick={() => setOpenModal(false)}>
			<div className='modalContainer' onClick={(e) => e.stopPropagation()}>
				...
				<form method='post'>
					...
					<label className='userInput' htmlFor='timezone'>
						Time Zone
					</label>
					...
					<div className='addTags'>
						...
						<div className='tagInput'>
							...
							<button onClick={addTag} id='tagBtn' type='button'>
								Add Tag
							</button>
						</div>
					...
					<div className='footer'>
						...
						<button onClick={submitNewGroupInfo} className='submitBtn'>
							Submit
						</button>
					</div>
				</form>
