				...
				<div className='editCharacterSection'>
					<div className='editCharacterForm'>
						<form method='post' className='autoFillForm'>
							...
							<button onClick={pullCharInfo} className='submitBtn'>
								Search
							</button>
						</form>
						...
						<form method='post' className='manualForm'>
							...
							<div className='editCharFooter'>
								<button onClick={() => setOpenModal(false)} className='submitBtn'>
									Cancel
								</button>
								<button onClick={updateCharacter} className='submitBtn'>
									Submit
								</button>
							</div>
						</form>
					...
					<div className='charDisplay'>
						...
						<div className='characterPreview'>
							{' '}
							<CharacterDetails char={charData} />{' '}
						</div>
					</div>
				</div>
			</div>
