			...
			<div className='addCharacterSection'>
				<div className='addCharacterForm'>
					<form method='post' className='autoFillForm'>
						...
						<button className='submitBtn' onClick={pullCharInfo}>
							Search
						</button>
					</form>
