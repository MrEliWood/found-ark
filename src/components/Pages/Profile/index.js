		...
		<div className='page'>
			<div className='tabHeader'>
				...
				<div className='tabs' onClick={handleTabSelect}>
					...
					<label htmlFor='allCharTab' className={currentTab === 'MyCharacters' ? 'tabLabel activeTab' : 'tabLabel'}>
						My Characters
					</label>

					<input type='radio' id='newCharTab' name='profileTabs' value='newCharTab' className='tab'></input>
					<label htmlFor='newCharTab' className={currentTab === 'AddCharacter' ? 'tabLabel activeTab' : 'tabLabel'}>
						Add Character
					</label>
					...
					<label htmlFor='editInfoTab' className={currentTab === 'EditInfo' ? 'tabLabel activeTab' : 'tabLabel'}>
						Edit Profile
					</label>
				</div>
			</div>
