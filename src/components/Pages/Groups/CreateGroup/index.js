		...
		<div className='darkContainerWrapped'>
			...
			<form method='post' className='createGroup'>
				<div className='createGroupColumn'>
					...
					<div className='formItem'>
						<label className='' htmlFor='characters'>
							Group Leader
						</label>
				...
				<div className='createGroupColumn'>
					<div className='formItem'>
						<label className='' htmlFor='dayofweek'>
							Day
						</label>
					...
					<div className='formItem'>
						<label className='' htmlFor='timezone'>
							Time Zone
						</label>
					...
					<button type='submit' className='createGroupSubmitBtn' onClick={handleFormSubmit}>
						Create Group
					</button>
				</div>
			</form>
