	...
	return (
		<div className='darkContainer'>
			...
			{allGroups
				...
				.map((group, index) => {
					return (
						<div key={group.id} id={group.id} className={group.id % 4 === 0 ? 'groupPreview bgTree' : group.id % 3 === 0 ? 'groupPreview bgGiant' : group.id % 2 === 0 ? 'groupPreview bgCity' : 'groupPreview bgSky'} onClick={handleGroupClick} style={{ animation: `fade-up 0.5s both ${index / 4 + 1.5}s` }}>
